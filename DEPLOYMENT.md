...
NEXT_PUBLIC_WORKOS_REDIRECT_URI=https://yula.dev/callback
...
# Distributed idempotency/rate limiting
UPSTASH_REDIS_REST_URL=https://...
UPSTASH_REDIS_REST_TOKEN=...
```

Provider-specific messaging, Sentry, and deployment platform secrets should be configured only for the surfaces that use them. See `.env.example` for the broad local inventory.
