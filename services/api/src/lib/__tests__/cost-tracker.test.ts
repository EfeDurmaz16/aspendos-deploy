...
describe('Cost Tracker', () => {
    describe('MODEL_PRICING', () => {
        ...
        it('should have positive pricing values', () => {
            expect(MODEL_PRICING['gpt-5'].input).toBeGreaterThan(0);
            expect(MODEL_PRICING['gpt-5'].output).toBeGreaterThan(0);
            expect(MODEL_PRICING['gpt-5-mini'].input).toBeGreaterThan(0);
            expect(MODEL_PRICING['gpt-5-mini'].output).toBeGreaterThan(0);
        });

        it('should have output pricing higher than input pricing', () => {
            expect(MODEL_PRICING['gpt-5'].output).toBeGreaterThan(MODEL_PRICING['gpt-5'].input);
            expect(MODEL_PRICING['claude-sonnet-4-6'].output).toBeGreaterThan(
    ...
    describe('calculateCost', () => {
        ...
        it('should calculate cost correctly for Claude Sonnet', () => {
            ...
            // total: 0.0135
            const cost = calculateCost('claude-sonnet-4-6', 2000, 500);
        ...
        it('should calculate cost correctly for Llama', () => {
            ...
            // total: 0.00138
            const cost = calculateCost('llama-4-maverick', 1000, 1000);
        ...
        it('should handle only input tokens', () => {
            ...
            // total: 0.0025
            const cost = calculateCost('gpt-5', 1000, 0);
        ...
        it('should handle only output tokens', () => {
            ...
            // output: (1000/1000) * 0.01 = 0.01
            // total: 0.01
            const cost = calculateCost('gpt-5', 0, 1000);
        ...
        it('should calculate cost correctly for fractional tokens', () => {
            ...
            // total: 0.00375
            const cost = calculateCost('gpt-5', 500, 250);
        ...
        it('should handle large token counts', () => {
            ...
            // total: 0.75
            const cost = calculateCost('gpt-5', 100000, 50000);
            expect(cost).toBe(0.75);
        });

        it('should return precise floating point results', () => {
            const cost = calculateCost('gpt-5-mini', 123, 456);
    ...
    describe('Cost comparison', () => {
        it('should show GPT-4o is more expensive than GPT-4o-mini', () => {
            const costGpt4o = calculateCost('gpt-5', 1000, 1000);
            const costGpt4oMini = calculateCost('gpt-5-mini', 1000, 1000);
            expect(costGpt4o).toBeGreaterThan(costGpt4oMini);
        });

        it('should show Claude Sonnet is more expensive than Claude Haiku', () => {
            const costSonnet = calculateCost('claude-sonnet-4-6', 1000, 1000);
        ...
        it('should show Gemini is cheapest for same token count', () => {
            ...
            const costs = [
                calculateCost('gpt-5', tokens.in, tokens.out),
