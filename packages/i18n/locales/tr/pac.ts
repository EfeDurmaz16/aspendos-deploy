export default {
    ...
    demo: {
        notification1: {
            ...
            message:
                'Q4 incelemesi için hazırlanmaktan bahsetmiştin. Konuşma noktaları hazırlamana yardımcı olmamı ister misin?',
        },
        notification2: {
            title: 'Annenin doğum günü yarın!',
            message:
                'Çiçek siparişi vermek istediğinden bahsetmiştin. Yakındaki çiçekçileri bulmana yardımcı olayım mı?',
        },
        notification3: {
            title: 'Projeni takip et',
            message:
                'Kimlik doğrulama sorununu çözmeye çalışıyordun. Token yenilemeyi düzeltebildin mi?',
        },
    },
};
