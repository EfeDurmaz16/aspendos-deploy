export default {
    ...
    demo: {
        notification1: {
            ...
            message:
                'You mentioned preparing for the Q4 review. Want me to help draft talking points?',
        },
        notification2: {
            title: "Mom's birthday is tomorrow!",
            message:
                'You mentioned wanting to order flowers. Should I help you find local florists?',
        },
        notification3: {
