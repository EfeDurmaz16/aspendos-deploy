        ...
        <SafeAreaView className={`flex-1 ${bgColor}`} edges={['top']}>
            <ScrollView className="flex-1 px-4">
                ...
                <View className="py-6">
                    ...
                    <Text className={`text-base ${subtextColor} mt-1`}>Your AI Companion</Text>
                </View>
                    ...
                    <View className="flex-row flex-wrap gap-3">
                        {quickActions.map((action) => (
                            ...
                            >
                                ...
                                <Text className={`font-semibold ${textColor}`}>{action.title}</Text>
                ...
                <View className={`p-5 rounded-xl mb-6 ${cardBg} border ${borderColor}`}>
                    ...
                    <Text className={`${subtextColor} text-sm leading-5`}>
                        YULA can message you first! Set reminders naturally or let YULA detect your
                        commitments and follow up automatically.
                    </Text>
                    <TouchableOpacity onPress={() => router.push('/(tabs)/pac')} className="mt-4">
                ...
                <View className="mb-6">
                    <View className="flex-row items-center justify-between mb-3">
                        <Text className={`text-sm font-medium ${subtextColor}`}>RECENT CHATS</Text>
