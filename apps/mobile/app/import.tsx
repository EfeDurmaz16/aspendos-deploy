            ...
            <ScrollView className="flex-1" showsVerticalScrollIndicator={false}>
                ...
                <View className="px-4 py-4">
                    ...
                    <TouchableOpacity className="flex-row items-center mt-3">
                        ...
                        <Text className="text-blue-500 text-sm ml-1">View detailed guide</Text>
                    </TouchableOpacity>
                </View>

                {/* File Upload */}
                <View className="px-4 py-4">
                    <Text className={`text-sm font-medium ${subtextColor} mb-3`}>UPLOAD FILE</Text>
                    ...
                    >
                        {selectedFile ? (
                            ...
                            <>
                                ...
                                <Text className={`font-medium ${textColor}`}>Select JSON file</Text>
                                <Text className={`text-sm ${subtextColor} mt-1`}>
                                    Tap to browse files
                                </Text>
                            </>
                    ...
                    <View className="flex-row items-start">
                        ...
                        <View className="ml-3 flex-1">
                            ...
                            <Text className="text-blue-600 dark:text-blue-400 text-sm mt-1">
                                Imported conversations are stored securely and never shared. You can
                                delete them anytime from settings.
                            </Text>
                        </View>
                    </View>
                </View>
                ...
                >
                    <Text
                        className={`font-semibold ${
                            selectedFile && !isUploading ? 'text-white' : subtextColor
                        }`}
                    >
