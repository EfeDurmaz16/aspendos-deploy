            ...
            <motion.div layout className={cn('relative inline-flex items-center gap-2', className)}>
                ...
                >
                    <Button
                        ...
                        className={cn(
                            sizeVariants[size],
                            'cursor-pointer transition-shadow text-white bg-rose-500 hover:bg-rose-600 dark:bg-rose-600 dark:hover:bg-rose-700',
                        ...
                        >
                            <Button
                                ...
                                className={cn(
                                    ...
                                    'cursor-pointer transition-shadow bg-white/50 dark:bg-zinc-900/50 border-zinc-200 dark:border-zinc-800 hover:bg-zinc-100 dark:hover:bg-zinc-800'
                                )}
