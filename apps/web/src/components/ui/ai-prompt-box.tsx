...
// Custom Divider Component - YULA Monolith amber accent
const CustomDivider: React.FC = () => (
    <div className="relative h-6 w-[1.5px] mx-1">
        <div
            className="absolute inset-0 bg-gradient-to-t from-transparent via-amber-500/60 to-transparent rounded-full"
            style={{
                clipPath:
