...
const ResponsiveHeroBanner: React.FC<ResponsiveHeroBannerProps> = ({
    ...
    backgroundImageUrl: _backgroundImageUrl = 'https://hoirqrkdgbmvpwutwuwj.supabase.co/storage/v1/object/public/assets/assets/0e2dbea0-c0a9-413f-a57b-af279633c0df_3840w.jpg',
    navLinks = [
    ...
    return (
        <section className="w-full isolate min-h-screen overflow-hidden relative">
            {/* Removed Background Image and Overlay to respect parent context (Aurora) */}
            ...
            <div className="z-10 relative">
                <div className="sm:pt-28 md:pt-32 lg:pt-40 max-w-7xl mx-auto pt-28 px-6 pb-16">
                    <div className="mx-auto max-w-3xl text-center">
                        <div className="mb-6 inline-flex items-center gap-3 rounded-full bg-white/50 dark:bg-zinc-900/50 px-2.5 py-2 ring-1 ring-zinc-200 dark:ring-zinc-800 backdrop-blur animate-fade-slide-in-1 shadow-sm">
                            <span className="inline-flex items-center text-xs font-medium text-emerald-700 dark:text-emerald-300 bg-emerald-100 dark:bg-emerald-900/30 rounded-full py-0.5 px-2 font-sans">
                                {badgeLabel}
                            </span>
                            <span className="text-sm font-medium text-zinc-900 dark:text-zinc-50 font-sans">
                                {badgeText}
                            </span>
                        </div>

                        <h1 className="sm:text-5xl md:text-6xl lg:text-7xl leading-tight text-4xl text-zinc-900 dark:text-zinc-50 tracking-tight font-instrument-serif font-normal animate-fade-slide-in-2">
                            {title}
                            <br className="hidden sm:block" />
                            {titleLine2}
                        </h1>

                        <p className="sm:text-lg animate-fade-slide-in-3 text-base text-zinc-600 dark:text-zinc-400 max-w-2xl mt-6 mx-auto">
                            {description}
                        </p>
