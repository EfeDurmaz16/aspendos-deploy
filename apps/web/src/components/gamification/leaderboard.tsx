    ...
    return (
        ...
        >
            ...
            <div className="text-right">
                <p className="font-semibold text-foreground">{entry.totalXp.toLocaleString()}</p>
...
export function LeaderboardTabs({ activeTab, onChange, className }: LeaderboardTabsProps) {
    const tabs = [
