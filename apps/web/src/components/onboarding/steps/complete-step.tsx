...
import { PartyPopper, ArrowRight, Sparkles, MessageSquare, Trophy } from 'lucide-react';
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <div className="text-left">
            <div className="text-sm font-semibold text-emerald-400">Achievement Unlocked!</div>
