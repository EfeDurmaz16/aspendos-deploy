...
import { Users, ArrowRight, Zap, Brain, Shield, Palette } from 'lucide-react';
            ...
            >
              <div className="flex items-center gap-2 mb-2">
                <div
                  ...
                  style={{
                    backgroundColor: PERSONAS.find((p) => p.id === selectedPersona)?.color,
                  }}
                >
                  {PERSONAS.find((p) => p.id === selectedPersona)?.icon}
                </div>
                <span className="text-xs font-medium text-white">
                  {PERSONAS.find((p) => p.id === selectedPersona)?.name}'s Response
                </span>
              </div>
