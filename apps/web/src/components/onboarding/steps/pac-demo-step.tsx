...
import { Bell, ArrowRight, MessageCircle, Calendar, Lightbulb } from 'lucide-react';
    ...
    >
        ...
        <div className="rounded-xl border border-white/10 bg-white/[0.02] overflow-hidden">
          ...
          <AnimatePresence mode="wait">
            <motion.div
              ...
              className="p-4"
            >
              <NotificationCard notification={DEMO_NOTIFICATIONS[activeNotification]} />
            </motion.div>
          </AnimatePresence>
        </div>
      </div>
      ...
      <div className="mb-6 w-full max-w-md">
        <div className="flex items-start gap-3">
          ...
          <div>
            <div className="text-sm font-medium text-white">You mention a commitment</div>
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <div className="text-xs text-zinc-500">Stores the intent and schedules follow-up</div>
          </div>
        </div>
        <div className="ml-4 h-6 border-l border-dashed border-white/10" />
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <div className="text-xs text-zinc-500">At the right time, YULA checks in</div>
          </div>
        </div>
      </div>
  ...
  return (
    <div className="flex gap-3">
      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="mt-1 text-xs text-zinc-400 line-clamp-2">{notification.message}</div>
