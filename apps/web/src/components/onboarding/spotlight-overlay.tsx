          ...
          <div className="flex gap-1">
            {Array.from({ length: totalSteps }).map((_, i) => (
              <div
                ...
                style={i === currentIndex ? { backgroundColor: config.accentColor } : undefined}
              />
            ))}
          </div>
    ...
    <AnimatePresence>
      ...
      >
        ...
        <div className="absolute inset-0 pointer-events-auto" onClick={skipTour}>
          <SpotlightMask spotlight={spotlight} prefersReducedMotion={prefersReducedMotion} />
        </div>
        ...
        {spotlight && (
          <motion.div
            ...
            transition={
              prefersReducedMotion ? {} : { duration: TRANSITION_DURATION, ease: 'easeInOut' }
            }
          />
        )}
...
export { type SpotlightRect, type TooltipPosition, type SpotlightTarget };
