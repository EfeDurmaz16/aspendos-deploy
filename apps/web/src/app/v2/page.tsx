...
export default function LandingPageV2() {
    ...
    const useCases = [
        {
            ...
            description:
                'Analyze complex documents, extract insights, and synthesize information from multiple sources.',
            icon: Eye,
        },
        {
            title: 'Code Development',
            description:
                'Write, debug, and refactor code with context-aware assistance across your entire project.',
            icon: Terminal,
        },
        {
            title: 'Content Creation',
            description:
                'Draft emails, reports, and creative content with your personal writing style preserved.',
            icon: Globe,
        },
        {
            title: 'Task Automation',
            description:
                'Schedule reminders, automate workflows, and let AI proactively manage your tasks.',
            icon: Clock,
        },
    ];
    ...
    const earlyAdopterBenefits = [
        {
            ...
            description:
                'One conversation thread that works across GPT-4, Claude, and Gemini. Context that actually persists.',
        },
        {
            title: 'Smart Routing',
            description:
                'Automatic model selection based on your query. Always get the best AI for the task.',
        },
        {
            title: 'Proactive AI',
            description:
                'Schedule reminders and let AI initiate conversations when needed. Your AI works for you.',
        },
    ];
    ...
    const faqs = [
        ...
        },
        {
            ...
            answer: 'Yes. All data is encrypted at rest and in transit. We never train on your data, and you can export or delete your memory at any time. Enterprise plans include SOC 2 compliance.',
        },
        {
            question: 'Can I use my own API keys?',
            answer: 'Pro and Ultra plans support bringing your own API keys for direct provider access. This gives you more control over rate limits and billing.',
        },
        {
            question: 'What happens when I exceed my limits?',
            answer: "You'll receive notifications at 75%, 90%, and 100% of your monthly limit. After hitting 100%, you can purchase additional credits or wait for the next billing cycle.",
        },
    ];
        ...
        <div className="min-h-screen bg-black text-white overflow-x-hidden">
            ...
            >
                ...
                <div className="relative z-10 max-w-5xl mx-auto text-center">
                    ...
                    >
                        Stop switching tabs. Stop repeating yourself. Access GPT-4, Claude, and
                        Gemini through a single interface that remembers everything.
                    </motion.p>
            ...
            <CinematicSection className="py-32 px-6">
                <div className="max-w-6xl mx-auto">
                    <div className="grid md:grid-cols-2 gap-16 md:gap-24">
                        <div>
                            <span className="font-mono text-xs text-red-400 tracking-widest uppercase mb-4 block">
                                The Problem
                            </span>
                            ...
                            <p className="text-zinc-400 leading-relaxed mb-6">
                                You use ChatGPT for writing, Claude for analysis, Gemini for
                                research. Each conversation exists in isolation. Context is lost.
                ...
                <div className="max-w-4xl mx-auto">
                    <CinematicSection className="mb-12 text-center">
                        ...
                        <p className="text-zinc-400 max-w-xl mx-auto">
                            Access the world&apos;s best AI models through a single, unified
                            experience.
                        </p>
                    </CinematicSection>
            ...
            <section id="pricing" className="py-32 px-6">
                <div className="max-w-5xl mx-auto">
                    <CinematicSection className="mb-16 text-center">
                        ...
                        <p className="text-zinc-400 max-w-xl mx-auto">
                            Access premium AI models that typically cost $200+/month. All unified in
                            one subscription.
                        </p>
                    </CinematicSection>
