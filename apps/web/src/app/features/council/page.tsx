...
const councilData: FeatureData = {
    name: 'Council Mode',
    slug: 'council',
    tagline: 'Query multiple AI models simultaneously. Compare GPT-5, Claude, Gemini, and Llama responses side-by-side to get the best answer.',
    ...
    benefits: [
        {
            ...
            description: 'Different AI models have different strengths. Council Mode lets you leverage all of them at once.',
        },
        {
            title: 'Choose the Best Answer',
            description: 'Compare responses side-by-side and pick the best one, or combine insights from multiple models.',
        },
        {
            title: 'Save Time',
            description: 'Instead of asking the same question to different models separately, get all responses simultaneously.',
        },
        {
            title: 'Reduce AI Bias',
            description: 'Cross-reference answers from multiple providers to get a more balanced, reliable response.',
        },
    ],
    howItWorks: [
        {
            ...
            description: 'Choose which AI models you want to query - GPT-5, Claude, Gemini, Llama, or any combination.',
        },
        {
            step: 2,
            title: 'Ask your question',
            description: 'Type your question once. YULA sends it to all selected models simultaneously.',
        },
        {
            step: 3,
            title: 'Compare responses',
            description: 'View all responses side-by-side as they stream in. Each model responds independently.',
        },
        {
            step: 4,
            title: 'Choose or combine',
            description: 'Pick the best response, or ask YULA to synthesize insights from multiple answers.',
        },
    ],
    useCases: [
        {
            title: 'Complex Decisions',
            description: 'Get multiple perspectives on business decisions, technical architecture, or life choices.',
        },
        {
            title: 'Fact Verification',
            description: 'Cross-reference factual claims across models to reduce hallucinations and increase accuracy.',
        },
        {
            title: 'Creative Writing',
            description: 'Get different creative approaches from each model and combine the best elements.',
        },
        {
            title: 'Code Review',
            description: 'Have multiple AI models review your code. Each might catch different issues.',
        },
    ],
    faqs: [
        {
