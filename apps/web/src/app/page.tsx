...
function Navigation() {
    return (
        <nav className="fixed top-0 left-0 right-0 z-50 px-8 py-4" style={{ backgroundColor: COLORS.navy }}>
...
function HeroSection() {
    return (
        <section
            className="min-h-screen pt-24 pb-16 px-8"
        ...
        >
            <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center min-h-[80vh]">
                ...
                <div className="space-y-8">
                    ...
                    >
                        YULA OS brings together the world's best AI models in one intelligent platform.
                        Import your history, get proactive reminders, and let multiple AIs debate your toughest decisions.
                    </motion.p>
                ...
                >
                    ...
                    >
                        ...
                        <div className="flex items-center gap-4">
                            <div className="text-xs" style={{ color: COLORS.textMuted }}>✦ IMPORT</div>
                            <div className="flex-1 h-px" style={{ backgroundColor: COLORS.textMuted, opacity: 0.3 }} />
                        </div>
                        <div
                            className="rounded-lg p-4 border"
                            style={{ borderColor: `${COLORS.textMuted}30` }}
                        >
                            <div className="w-24 h-3 rounded" style={{ backgroundColor: `${COLORS.textMuted}30` }} />
                        </div>

                        {/* PAC Card */}
                        <div className="flex items-center gap-4">
                            <div className="text-xs" style={{ color: COLORS.textMuted }}>✦ PAC</div>
                            <div className="flex-1 h-px" style={{ backgroundColor: COLORS.textMuted, opacity: 0.3 }} />
                        </div>
                        <div
                            className="rounded-lg p-4 border"
                            style={{ borderColor: `${COLORS.textMuted}30` }}
                        >
                            <div className="w-32 h-3 rounded" style={{ backgroundColor: `${COLORS.textMuted}30` }} />
                        </div>

                        {/* Council Card */}
                        <div className="flex items-center gap-4">
                            <div className="text-xs" style={{ color: COLORS.textMuted }}>✦ COUNCIL</div>
                            <div className="flex-1 h-px" style={{ backgroundColor: COLORS.textMuted, opacity: 0.3 }} />
                        </div>
    ...
    return (
        ...
        >
            <div className="max-w-7xl mx-auto">
                ...
                {/* Feature Columns */}
                <div className="grid md:grid-cols-3 gap-0 border-t" style={{ borderColor: COLORS.creamDark }}>
...
function HowItWorksSection() {
    const steps = [
        { number: '01', title: 'Import', description: 'Import your conversations from ChatGPT and Claude.' },
        { number: '02', title: 'Chat', description: 'Chat naturally - YULA learns your preferences.' },
        { number: '03', title: 'Remind', description: 'Get proactive reminders for commitments and goals.' },
        { number: '04', title: 'Council', description: 'Use Council for decisions that require multiple perspectives.' },
    ];
                ...
                <div className="grid md:grid-cols-3 gap-6">
                    {plans.map((plan, idx) => (
                        <div
                            ...
                            style={{
                                backgroundColor: plan.popular ? COLORS.terracotta : COLORS.navyLight,
                        ...
                        >
                            ...
                            <button
                                ...
                                style={{
                                    ...
                                    border: plan.popular ? 'none' : `1px solid ${COLORS.textMuted}50`,
                                    fontFamily: "'DM Sans', sans-serif"
                                }}
                            >
                                {plan.cta}
...
function Footer() {
    return (
        <footer
            ...
            style={{ backgroundColor: COLORS.navy }}
        >
            <div className="max-w-7xl mx-auto flex flex-wrap justify-between items-center gap-4 text-xs" style={{ color: COLORS.textMuted, fontFamily: "'DM Sans', sans-serif" }}>
