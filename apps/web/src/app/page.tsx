    ...
    return (
        <div className="flex flex-col min-h-screen font-sans bg-background text-foreground selection:bg-zinc-200 selection:text-zinc-900">
            ...
            <main className="flex-1">
                ...
                <section className="relative pt-32 pb-24 lg:pt-48 lg:pb-32 px-6 lg:px-8 overflow-hidden gradient-mesh">
                    <div className="container max-w-7xl mx-auto text-center relative z-10">
                        ...
                        <p className="text-[17px] md:text-[19px] leading-relaxed text-zinc-600 dark:text-zinc-400 max-w-2xl mx-auto mb-12 animate-fade-up opacity-0 animation-delay-200">
                            Aspendos unifies GPT-4o, Claude 3.5, and Gemini into a single OS with
                            persistent memory. Save context, save money, and build a second brain
                        ...
                        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-fade-up opacity-0 animation-delay-300">
                            <Button
                                size="lg"
                                className="rounded-full px-8 text-[15px] h-12 shadow-lg hover:shadow-xl transition-all group"
                                asChild
                            >
                                <Link href="/signup">
                                    Start Free Trial
                            ...
                            <Button
                                variant="outline"
                                size="lg"
                                className="rounded-full px-8 text-[15px] h-12 glass hover:bg-white/80 dark:hover:bg-zinc-800/80"
                                asChild
                            >
                ...
                <section
                    id="demo"
                    className="py-24 px-6 lg:px-8 bg-zinc-50/50 dark:bg-zinc-900/50 border-y border-zinc-200/50 dark:border-zinc-800 grid-pattern"
                >
                    <div className="container max-w-5xl mx-auto">
                        <div className="bg-white dark:bg-black rounded-2xl shadow-xl border border-zinc-200 dark:border-zinc-800 overflow-hidden h-[600px] relative flex flex-col items-center justify-center text-center p-12 hover-lift">
                            ...
                            <div className="animate-float">
                                <Brain
                                    className="w-16 h-16 text-zinc-300 dark:text-zinc-700 mb-6"
                                    weight="duotone"
                                />
                            </div>
                            <h3 className="font-serif text-3xl mb-4 text-zinc-900 dark:text-white">
                                Interactive Memory Demo
                            </h3>
                            <p className="text-zinc-500 max-w-md mx-auto mb-8">
                                Try asking "What project am I working on?" after telling the AI
                                about your work.
                                <br />
                            ...
                            <Button variant="secondary" disabled className="animate-pulse-glow">
                                Start Demo
                            </Button>
                        </div>
                    </div>
                ...
                <section id="features" className="py-32 px-6 lg:px-8">
                    <div className="container max-w-7xl mx-auto">
                        <div className="mb-20">
                            <h2 className="font-serif text-4xl md:text-5xl mb-6 text-zinc-900 dark:text-zinc-50">
                                The Aspendos Method
                            </h2>
                            <p className="text-[17px] text-zinc-700 dark:text-zinc-400 max-w-xl">
                                Most AI tools are amnesiacs. We built a knowledge graph that
                                persists across every conversation and every model.
                            </p>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 auto-rows-[400px]">
                            ...
                            <div className="group relative overflow-hidden rounded-3xl bg-zinc-100 dark:bg-zinc-900 p-10 flex flex-col justify-between border border-transparent hover:border-zinc-200 dark:hover:border-zinc-800 transition-all hover-lift">
                                ...
                                <div className="mt-auto relative z-10">
                                    <h3 className="font-serif text-2xl mb-3 text-zinc-900 dark:text-white">
                                        Multi-Model Core
                                    </h3>
                                    <p className="text-[15px] leading-relaxed text-zinc-700 dark:text-zinc-400">
                                        Switch between GPT-4o, Claude 3.5, and Gemini Pro instantly.
                                        Ask one, verify with another.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="md:col-span-2 group relative overflow-hidden rounded-3xl bg-zinc-900 dark:bg-zinc-50 p-10 flex flex-col justify-between text-white dark:text-zinc-900 shadow-2xl hover-lift">
                                ...
                                <div className="relative z-10 max-w-lg">
                                    ...
                                    <p className="text-[17px] opacity-80 leading-relaxed">
                                        Aspendos doesn't just store logs. It maps concepts,
                                        entities, and relationships into a 3D graph. It remembers
                                        that "Project Alpha" is a "SaaS platform" using "Next.js".
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="group relative overflow-hidden rounded-3xl bg-zinc-100 dark:bg-zinc-900 p-10 flex flex-col justify-between border border-transparent hover:border-zinc-200 dark:hover:border-zinc-800 transition-all hover-lift">
                                ...
                                <div className="mt-auto relative z-10">
                                    ...
                                    <p className="text-[15px] leading-relaxed text-zinc-700 dark:text-zinc-400">
                                        Talk to your OS naturally. Interruptible, low-latency voice
                                        mode for when you're on the move.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="group relative overflow-hidden rounded-3xl bg-zinc-100 dark:bg-zinc-900 p-10 flex flex-col justify-between border border-transparent hover:border-zinc-200 dark:hover:border-zinc-800 transition-all hover-lift">
                                ...
                                <div className="mt-auto relative z-10">
                                    ...
                                    <p className="text-[15px] leading-relaxed text-zinc-700 dark:text-zinc-400">
                                        $49/mo covers everything. No more separate invoices for
                            ...
                            <div className="group relative overflow-hidden rounded-3xl bg-gradient-to-br from-zinc-50 to-zinc-100 dark:from-zinc-950 dark:to-zinc-900 p-10 flex flex-col justify-center items-center text-center border-2 border-dashed border-zinc-200 dark:border-zinc-800 hover:border-zinc-300 dark:hover:border-zinc-700 transition-all cursor-pointer hover-lift">
                                <Lightning
                                    size={48}
                                    className="text-zinc-300 mb-6 group-hover:text-amber-400 transition-colors animate-float"
                                    weight="fill"
                                />
                                <h3 className="font-serif text-2xl mb-2 text-zinc-900 dark:text-white">
                                    Ready to upgrade?
                                </h3>
                ...
                <section
                    id="pricing"
                    className="py-24 px-6 lg:px-8 border-t border-zinc-100 dark:border-zinc-900 bg-zinc-50/50 dark:bg-zinc-950/50"
                >
                    <div className="container max-w-7xl mx-auto">
                        <div className="mb-16 text-center max-w-2xl mx-auto">
                            <h2 className="font-serif text-4xl mb-6 text-zinc-900 dark:text-zinc-50">
                                Simple, unified pricing.
                            </h2>
                            <p className="text-[17px] text-zinc-700 dark:text-zinc-400">
                                Replace 3+ subscriptions with one. Get the best models and
                                persistent memory for less than the cost of GPT-4 alone.
                            </p>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
                            ...
                            <div className="rounded-2xl p-8 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 shadow-sm flex flex-col hover-lift">
                                <div className="mb-6">
                                    ...
                                    <p className="text-sm text-zinc-500 mt-2">
                                        Perfect for trying out the memory engine.
                                    </p>
                                </div>
                            ...
                            <div className="rounded-2xl p-8 bg-zinc-900 dark:bg-zinc-50 border border-zinc-900 dark:border-white shadow-xl flex flex-col relative overflow-hidden transform md:-translate-y-4 glow">
                                ...
                                <div className="mb-6">
                                    <h3 className="font-serif text-xl mb-2 text-white dark:text-zinc-900">
                                        Pro
                                    </h3>
                                    <div className="flex items-baseline gap-1">
                                        <span className="text-4xl font-semibold tracking-tight text-white dark:text-zinc-900">
                                            $29
                                        </span>
                                ...
                                <Button
                                    className="w-full rounded-full bg-white text-zinc-900 hover:bg-zinc-200 dark:bg-zinc-900 dark:text-white dark:hover:bg-zinc-800"
                                    asChild
                                >
            ...
            <footer className="py-16 border-t border-zinc-100 dark:border-zinc-900">
                <div className="container max-w-7xl mx-auto px-6 lg:px-8">
                    <div className="flex flex-col md:flex-row justify-between items-start gap-12">
                        <div>
                            <span className="font-serif text-2xl font-semibold tracking-tight text-zinc-900 dark:text-white">
                                ASPENDOS
                            </span>
                            <p className="text-sm text-zinc-500 mt-2 max-w-xs">
                                The memory-first AI operating system for power users.
                            </p>
                        </div>
