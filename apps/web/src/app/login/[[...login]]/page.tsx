            ...
            <div className="relative flex min-h-screen flex-col justify-center p-4">
                ...
                <div className="mx-auto space-y-4 sm:w-sm w-full max-w-md">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <Button type="submit" size="lg" className="w-full bg-zinc-900 dark:bg-zinc-50 text-white dark:text-zinc-900 hover:bg-zinc-800 dark:hover:bg-zinc-200 shadow-lg" disabled={isLoading}>
