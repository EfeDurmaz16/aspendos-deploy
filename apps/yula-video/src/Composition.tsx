...
const Scene1MemoryLiberty: React.FC = () => {
    ...
    // Absorption effect
    const absorbProgress = interpolate(frame, [fileAbsorbFrame, fileAbsorbFrame + 20], [0, 1], {
    ...
    return (
        ...
        >
            ...
            >
                ...
                <span style={{ color: COLORS.white50, fontSize: 11, marginTop: 8 }}>
                    Unified Memory
                </span>
            </div>
                    ...
                    <div key={model.id}>
                        ...
                        {isActive && nodeAppear > 0.5 && (
                            <ConnectionLine
                                ...
                                color={model.color}
                                progress={
                                    councilActive ? 1 : interpolate(nodeAppear, [0.5, 1], [0, 1])
                                }
                            />
                        )}
                        ...
                        >
                            <div
                                style={{
                                    ...
                                    justifyContent: 'center',
                                    boxShadow: isActive
                                        ? `0 0 ${20 + pulse * 20}px ${model.color}40`
                                        : 'none',
                                }}
                            >
                                <span
            ...
            {councilActive && (
                <div
                    style={{
                        ...
                        alignItems: 'center',
                        gap: 12,
                        opacity: interpolate(frame - councilFrame, [0, 15], [0, 1], {
                            extrapolateRight: 'clamp',
                        }),
                    }}
                >
                    ...
                    />
                    <span style={{ color: COLORS.white90, fontWeight: 500 }}>
                        Council Mode Active
                    </span>
                </div>
            )}
                ...
                <div style={{ display: 'flex', flex: 1 }}>
                    ...
                    <div style={{ flex: 1, padding: 24, background: 'rgba(0,0,0,0.2)' }}>
                        ...
                        >
                            ...
                            >
                                <span style={{ color: COLORS.white50, fontSize: 12 }}>
                                    Live Preview
                                </span>
                                <span style={{ color: COLORS.amber, fontSize: 12 }}>
                                    {Math.round(designProgress * 100)}%
                                </span>
                            </div>
                            <div
                                style={{
...
const Scene4PACMoment: React.FC = () => {
    ...
    const chatOpacity = interpolate(frame, [0, 15, clockFrame, clockFrame + 30], [0, 1, 1, 0], {
        extrapolateLeft: 'clamp',
        extrapolateRight: 'clamp',
    });
    ...
    return (
        ...
        >
            ...
            {/* Clock Animation */}
            {showClock && <ClockDial progress={clockProgress} />}
                ...
                >
                    ...
                    >
                        ...
                        <div>
                            ...
                            <div style={{ color: COLORS.white, fontSize: 18, fontWeight: 600 }}>
                    ...
                    <div style={{ padding: 20 }}>
                        ...
                        >
                            <div style={{ color: COLORS.white50, fontSize: 12, marginBottom: 8 }}>
                                Prepared tasks:
                            </div>
                            <TaskItem
                                text="Playwright tests generated (12 scenarios)"
                                status="done"
                            />
                ...
                >
                    ...
                    <div
                        style={{
                            ...glassStyle,
                            padding: '10px 24px',
                            opacity: interpolate(textAppear, [0.3, 1], [0, 1], {
                                extrapolateLeft: 'clamp',
                            }),
                        }}
                    >
...
const Scene5Outro: React.FC = () => {
    ...
    const subtextAppear =
        frame >= 2.5 * fps
            ...
            : 0;
    const ctaAppear =
        frame >= 4 * fps ? spring({ frame: frame - 4 * fps, fps, config: { damping: 200 } }) : 0;
    ...
    return (
        ...
        >
            ...
            >
                <span style={{ fontSize: 28, fontWeight: 600, color: COLORS.amber }}>yula.dev</span>
            </div>
        </AbsoluteFill>
    );
};
...
const ActionStep: React.FC<{ text: string; complete: boolean; frame: number; fps: number }> = ({
    ...
    return (
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 8 }}>
            ...
            <span style={{ color: complete ? COLORS.white70 : COLORS.white50, fontSize: 13 }}>
                {text}
            </span>
        </div>
    );
...
const FileIcon: React.FC = () => (
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
        ...
        <span
            style={{ marginTop: 8, color: COLORS.white70, fontSize: 12, fontFamily: 'monospace' }}
        >
            conversations.json
        </span>
    </div>
