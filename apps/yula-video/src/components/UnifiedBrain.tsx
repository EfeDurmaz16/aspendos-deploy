    ...
    return (
        <div className="relative w-[900px] h-[600px]">
            ...
            <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
                ...
                >
                    <div className="text-center">
                        <svg
                            className="w-12 h-12 text-white/80 mx-auto"
                            fill="currentColor"
                            viewBox="0 0 24 24"
                        >
            ...
            <div className="absolute bottom-0 left-1/2 -translate-x-1/2 glass rounded-full px-2 py-2 flex gap-2">
              ...
              ${activeModel === model.id ? 'bg-white/10 text-white' : 'text-white/50'}
            `}
                        style={{
            ...
            <div className="absolute top-20 left-1/2 -translate-x-1/2 text-center">
                <div className="glass rounded-lg px-6 py-4 max-w-md">
                    <div className="flex items-center gap-2 mb-2">
                        <svg
                            className="w-4 h-4 text-yula-amber"
                            fill="currentColor"
                            viewBox="0 0 20 20"
                        >
        ...
        <div className="flex flex-col items-center">
            <div
                ...
                style={{
                    ...
                    boxShadow: active ? `0 0 ${20 + pulse * 20}px ${color}40` : 'none',
                }}
            >
                <span
            ...
            {councilActive && <span className="text-xs text-white/40 mt-1">Contributing</span>}
        </div>
    );
};
