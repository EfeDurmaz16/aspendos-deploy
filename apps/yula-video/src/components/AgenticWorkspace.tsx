                ...
                <div className="w-1/2 bg-black/20 p-6">
                    <div className="h-full rounded-xl border border-white/10 overflow-hidden">
                        ...
                        <div className="px-4 py-2 border-b border-white/10 flex items-center justify-between">
                            ...
                            <div className="flex gap-2">
                                <span className="text-xs text-yula-amber">
...
const LoginFlowPreview: React.FC<LoginFlowPreviewProps> = ({ progress }) => {
    ...
    return (
        <div className="w-80 relative">
            {/* Skeleton State */}
            <div className="absolute inset-0 space-y-4" style={{ opacity: skeletonOpacity }}>
            ...
            {/* Real Content */}
            <div className="space-y-4" style={{ opacity: contentOpacity }}>
                {/* Logo */}
